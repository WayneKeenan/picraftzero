...
from .dualshock3 import DS3_PRODUCT_ID, DS3_VENDOR_ID, DualShock3
from .dualshock4 import DS4_PRODUCT_ID, DS4_VENDOR_ID, DualShock4
from .steamcontroller import SC_PRODUCT_ID, SC_VENDOR_ID, SteamController
from .xboxone import XB1S_VENDOR_ID, XB1S_WIRED_PRODUCT_ID, XB1S_WIRELESS_PRODUCT_ID, WiredXBoxOneSPad, \
    WirelessXBoxOneSPad
from .rockcandy import RockCandy, RC_PRODUCT_ID, RC_VENDOR_ID
